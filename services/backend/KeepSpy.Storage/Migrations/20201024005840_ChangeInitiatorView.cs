...
{
    public partial class ChangeInitiatorView : Migration
    {
                ...
                select sender_address id,
                       ...
                       (select sum(lot_size)
                        ...
                        where r.sender_address = s.sender_address
                          and r.status = 2) redeem_amount,
                       (select count(*) from redeem r where r.sender_address = s.sender_address and r.status = 2) redeem_count
                from (
